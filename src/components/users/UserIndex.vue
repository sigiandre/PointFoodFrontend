    ...
    <template v-else>
      <table class="table is-striped is-fullwidth">
        <thead>
          ...
          <th style="width:100px;">Dueño de Restaurante</th>
        </thead>
        <tbody>
          <tr v-for="item in collection.items" :key="item.id">
            ...
            <td>
              <span class="icon">
                <i v-if="item.roles.includes('CLIENT')" class="fa fa-check"></i>
                <i v-else class="fa fa-times"></i>
              </span>
            </td>
            <td>
              <span class="icon">
                <i v-if="item.roles.includes('RESTAURANTOWNER')" class="fa fa-check"></i>
                <i v-else class="fa fa-times"></i>
              </span>
            </td>
          </tr>
